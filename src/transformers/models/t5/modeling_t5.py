...
class T5Stack(T5PreTrainedModel):
    def __init__(self, config, embed_tokens=None, **kwargs):    # add **kwargs, Ionel
        ...
        self.block = nn.ModuleList(
            [T5Block(config, has_relative_attention_bias=bool(i == 0), **kwargs) for i in range(config.num_layers)]    # Added **kwargs, Ionel
        )
